...
ROM : 256GB  </p>
                        ...
                        <?php
                        if(check_if_added(1)){
                            echo '<button class="btn btn-success" disabled>Added to cart</button>';
                        }
                        else{
                            echo '<a href="cart-add.php?id=1" name="add" value="add" class="btn btn-primary btn-block">Add to cart</a>';
                        }
                        ?>
...
ROM : 128GB </p>
                        ...
                        if(check_if_added(2)){
                            ...
                            echo '<a href="cart-add.php?id=2" name="add" value="add" class="btn btn-primary btn-block">Add to cart</a>';
                        }
                        ?>
                    </div>
                        </div>
                ...
                <div class="col-xs-6 col-md-4">
                    ...
                    <div class="caption text-center">
                        ...
                        if(check_if_added(3)){
                            ...
                            echo '<a href="cart-add.php?id=3" name="add" value="add" class="btn btn-primary btn-block">Add to cart</a>';
                        }
                        ?>
                    </div>
                        </div>
                ...
                <div class="col-xs-6 col-md-4">
                    ...
                    <div class="caption text-center">
                        ...
                        if(check_if_added(4)){
                            ...
                            echo '<a href="cart-add.php?id=4" name="add" value="add" class="btn btn-primary btn-block">Add to cart</a>';
                        }
                        ?>
                    </div>
                        </div>
                ...
                <div class="col-xs-6 col-md-4">
                    ...
                    <div class="caption text-center">
                        ...
                        if(check_if_added(5)){
                            ...
                            echo '<a href="cart-add.php?id=5" name="add" value="add" class="btn btn-primary btn-block">Add to cart</a>';
                        }
                        ?>
                    </div>
                    </div>
                ...
                <div class="col-xs-6 col-md-4">
                    ...
                    <div class="caption text-center">
                        ...
                        if(check_if_added(6)){
                            ...
                            echo '<a href="cart-add.php?id=6" name="add" value="add" class="btn btn-primary btn-block">Add to cart</a>';
                        }
                        ?>
                    </div>
                    </div>
